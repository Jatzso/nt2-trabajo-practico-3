new Vue({
    ...
    methods: {
        ...
        ataqueEspecial: function () {
            ...
            this.turnos.unshift({
                esJugador: true,
                text: 'El jugador usa un ataque especial y daña al monstruo por ' + daño
            });
        ...
        curar: function () {
            if(this.saludJugador <= 90){
                ...
                this.turnos.unshift({
                    esJugador: true,
                    text: 'El jugador se cura 10 puntos de energia'
                });
            }else{
                this.saludJugador = 100;
                this.turnos.unshift({
                    esJugador: true,
                    text: 'El jugador regenera su energia maxima'
                });
            }
        ...
        ataqueDelMonstruo: function () {
            ...
            this.turnos.unshift({
                esJugador: false,
                text: 'El monstruo lastima al jugador en ' + daño
            });
